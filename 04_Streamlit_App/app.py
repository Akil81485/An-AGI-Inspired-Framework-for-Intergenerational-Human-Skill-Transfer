...
PIPELINE_DIR = PROJECT_ROOT / "03_AI_Pipeline"
...
def load_pipeline():
    ...
    excel_path = project_root / "02_Datasets" / "medical_experience_transfer_dataset.xlsx"
    cache_path = project_root / "temporary_search_db.pkl"

    return ExperienceGPTPipeline(
